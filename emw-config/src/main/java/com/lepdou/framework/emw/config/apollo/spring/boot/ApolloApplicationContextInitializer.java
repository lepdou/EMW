...
import com.lepdou.framework.emw.config.apollo.spring.util.SpringInjector;
...
public class ApolloApplicationContextInitializer implements
    ...
    private static final Logger   logger                   = LoggerFactory.getLogger(
            com.lepdou.framework.emw.config.apollo.spring.boot.ApolloApplicationContextInitializer.class);
    ...
    public void postProcessEnvironment(ConfigurableEnvironment configurableEnvironment, SpringApplication springApplication) {
        ...
        Boolean eagerLoadEnabled = configurableEnvironment.getProperty(PropertySourcesConstants.APOLLO_BOOTSTRAP_EAGER_LOAD_ENABLED,
                Boolean.class, false);
        ...
        Boolean bootstrapEnabled = configurableEnvironment.getProperty(PropertySourcesConstants.APOLLO_BOOTSTRAP_ENABLED, Boolean.class,
                false);
