...
import com.lepdou.framework.emw.config.apollo.util.http.HttpRequest;
import com.lepdou.framework.emw.config.apollo.util.http.HttpResponse;
...
public class ConfigServiceLocator {
    private static final Logger                            logger            = LoggerFactory.getLogger(
            com.lepdou.framework.emw.config.apollo.internals.ConfigServiceLocator.class);
    ...
    private List<ServiceDTO> getCustomizedConfigService() {
        ...
        logger.warn(
                "Located config services from apollo.configService configuration: {}, will not refresh config services from remote meta "
                        + "service!",
                configServices);
